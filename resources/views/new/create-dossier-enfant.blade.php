...
<div class="col-md-8 col-12 mr-auto ml-auto">
    ...
    <div class="wizard-container">
        <div class="card card-wizard" data-color="rose" id="wizardProfile">
            ...
            <form id="createDossier" action="/administration/DossierDesEnfants" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="picture-container">
                                        <div class="picture">
                                            ...
                                            <input type="file" id="wizard-picture" name="photoEnfant">
                                        </div>
